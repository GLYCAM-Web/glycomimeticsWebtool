...
#
#########################################################################
# $Header: /opt/cvs/python/packages/share1.5/NetworkEditor/Editor.py,v 1.81 2007/07/20 18:37:01 sargis Exp $
#
# $Id: Editor.py,v 1.81 2007/07/20 18:37:01 sargis Exp $
#
...
##                 self.unbindWidget = tk
            ...
            self.widgetMaster = kbComboBox(
                w1.interior(), label_text='Master:', labelpos='w',
...
class CodeEditorIdle_python24(CodeEditorIdle):
    ...
    def __init__(self, master=None, title='untitled',  code=None, font=None):
        ...
        if master:
            ...
            ed = self.widget = EditorWindow(root=self.editor.top.master.master,flist=self.editor.top.master)
