...
class ParamPanel:
    ...
    def __init__(self, node, master=None, title=None, applyFun=None,
        ...
        self.applyButton = Tkinter.Button(self.mainFrame, text="Apply",
...
##         traceback.print_stack()
        ...
        try:
            ...
            # running the node
            if self.forceExecution == 0 and len(self.inputPorts) > 0 :
                newdata = 0
            ...
            from NetworkEditor.macros import MacroInputNode
