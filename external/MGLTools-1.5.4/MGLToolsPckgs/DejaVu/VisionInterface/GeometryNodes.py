...
"""
    ...
    def selectionCommand_cb(self, event):
    ...
    def doit(self, name=None, geoms=None, instanceMatrices=None, 
        ...
        if   (self.selectedGeomIndex is None) \
          or (self.inputPortByName['geoms'].hasNewData() is False) \
          or (self.inputPortByName['geoms'].hasNewData() is True
...
"""
    ...
    def __init__(self, name='indexedPolygons', **kw):
        ...
        code = """def doit(self, coords, indices, vnormals=None, colors=None,
image=None, textureCoordinates=None,
...
Input Ports:
    ...
    quality: cylinder quality, the hight, the more polygons are drawn (default 5)
             (bound to a Thumbwheel in node)
    name:    name of the geometry
    instanceMatrices: stream of 4x4 transformation matrices (default identity)
    parent:  a geometry to parent the selected geometry (default root)

Output Ports:
    Cylinders: Cylinders geometry 
    allGeometries: list of all the geometries in the node
"""
    ...
    def __init__(self, name='cylinders', **kw):
        ...
        ip = self.inputPortsDescr
        ip.append(datatype='coord3(0)', name='coords', required=False)
        ip.append(datatype='indice2+(0)', name='indices', required=False)
        ip.append(datatype='colorfloat3or4(0)', name='colors', required=False)
        ip.append(datatype='float(0)', name='radius', required=False)
        ip.append(datatype='int', name='quality', required=False)
        ...
        code = """def doit(self, coords=((0,0,0),(10,0,0)), indices=((0,1),), colors=None,
radius=1.0, quality=5,
image=None,
name=None, geoms=None, instanceMatrices=None, geomOptions=None, parent=None):
    #print "doit", self.name
    GeometryNode.doit(self, name=name, geoms=geoms,
...
Input Ports:
    coords:  list of pairs of 3D points [((x1,y1,z1),(x2,y2,z2)) ...] (optional)
    indices:   nested lists of indices (1 tuple per line)
    colors:  list of RGB tuples (optional)
    radius:  float or list of floats of same length as coords (default is 1.0)
    quality: cylinder quality, the hight, the more polygons are drawn (default 5)
...
"""
    ...
    def __init__(self, name='axis', **kw):
        ...
        code = """def doit(self, coords=((0,0,0),(10,0,0)), indices=((0,1),), colors=None,
radius=.6, quality=15, headLength=None, headRadius=None,
image=None,
name=None, geoms=None, instanceMatrices=None, geomOptions=None, parent=None):
    #print "doit", self.name
    GeometryNode.doit(self, name=name, geoms=geoms,
...
Input Ports:
    ...
    colors:  list of RGB tuples (optional)
    radius:  float or list of floats of same length as coords (default is 1.0)
    quality: sphere quality, the hight, the more polygons are drawn (default 5)
             (bound to a Thumbwheel in node)
    name:    name of the geometry
    instanceMatrices: stream of 4x4 transformation matrices (default identity)
    parent:  a geometry to parent the selected geometry (default root)
...
"""
    ...
    def __init__(self, name='spheres', **kw):
        ...
        code = """def doit(self, coords=((0,0,0),), colors=None, radius=1.0, quality=5, 
image=None,
name=None, geoms=None, instanceMatrices=None, geomOptions=None, parent=None):
    #print "doit", self.name
    GeometryNode.doit(self, name=name, geoms=geoms,
...
Output Ports:
    ellipsoids: Ellipsoids geometry 
    allGeometries: list of all the geometries in the node
"""
    ...
    def __init__(self, name='ellipsoids', **kw):
        ...
        code = """def doit(self, ellipsoids, colors=None,
image=None,
name=None, geoms=None, instanceMatrices=None, geomOptions=None, parent=None):
    #print "doit", self.name
    GeometryNode.doit(self, name=name, geoms=geoms,
...
Output
    geom: IndexedPolygons height field
"""
    ...
    def __init__(self, name='heightField', **kw):
        ...
        ip.append({'name': 'scaleZ', 'datatype': 'float'})
        ...
        code = """def doit(self, data, scaleZ=1.0,
name=None, geoms=None, instanceMatrices=None, geomOptions=None, parent=None):
    #print "doit", self.name
    GeometryNode.doit(self, name=name, geoms=geoms,
                      instanceMatrices=instanceMatrices,
...
#            }
# 
#        code = """def doit(self, coords, labels, colors=None, font=None,
#name=None, geoms=None, instanceMatrices=None, geomOptions=None, parent=None):
#    #print "doit", self.name
#    #apply( GeometryNode.doit, (self,)+args )
#    GeometryNode.doit(self, name=name, geoms=geoms,
...
"""
    ...
    def __init__(self, name='glflabels', **kw):
        ...
        code = """def doit(self, coords=((0,0,0),), labels=None, vnormals=None, colors=None, 
billboard=None, includeCameraRotationInBillboard=None, font=None, fontstyle=None, 
fontSpacing=None, scaleXYZ=None, scaleX=None, scaleY=None, scaleZ=None,
fontRotateAngleX=None, fontRotateAngleY=None, fontRotateAngleZ=None, 
fontTranslateX=None, fontTranslateY=None, fontTranslateZ=None,
image=None,
name=None, geoms=None, instanceMatrices=None, geomOptions=None, parent=None):
    #print "doit", self.name
    #apply( GeometryNode.doit, (self,)+args )
...
def doit(self, centerx=None, centery=None, centerz=None, lengthx=None,
lengthy=None, lengthz=None, constrProps=None,
image=None, textureCoordinates=None,
name=None, geoms=None, instanceMatrices=None, geomOptions=None, parent=None):
    #print "doit", self.name
    #apply( GeometryNode.doit, (self,)+args )
    ...
    if self.selectedGeomIndex is not None:
        ...
        if constrProps:
            ...
            if self.inputPorts[3].hasNewData(): #x-length changed
                lengthy,lengthz=xyzprop[0][0]*lengthx,xyzprop[0][1]*lengthx
            if self.inputPorts[4].hasNewData(): #y-length changed
                lengthx,lengthz=xyzprop[1][0]*lengthy,xyzprop[1][1]*lengthy
            if self.inputPorts[5].hasNewData(): #z-length changed
...
Output Ports:
    stickerText: StickerText geometry 
    allGeometries: list of all the geometries in the node
"""
    ...
    def __init__(self, name='stickerText', **kw):
        ...
        ip = self.inputPortsDescr
        ip.append(datatype='string', required=False, name='label')
...
Output Ports:
    stickerImage: stickerImage geometry 
    allGeometries: list of all the geometries in the node
"""
...
class DecimateGeom(GeometryNode):
    ...
    Output Ports:
      decimateGeom - decimated geometry;
      allGeometries - list of all the geometries in the node."""
    ...
    def __init__(self, name = "decimateGeom", **kw):
        ...
        code = """def doit(self, geometry , percent, targetfaces=None, rebuild=None, u=None, v=None, name=None, geoms=None, instanceMatrices=None, geomOptions=None, parent=None):
    #print 'DecimateGeom: name=', name, 'percent=', percent, 'targetfaces=', targetfaces, 'rebuild=', rebuild, self.inputPortByName['rebuild'].hasNewData()
    ...
    #if self.inputPortByName['geometry'].hasNewData() or \
       #(self.inputPortByName['rebuild'].hasNewData() and rebuild):
    if self.inputPortByName['geometry'].hasNewData() or \
        self.inputPortByName['rebuild'].hasNewData():
    ...
    if self.inputPortByName['percent'].hasNewData(): #percent has changed
        targetfaces = int(maxFaces*percent/100.)
    elif self.inputPortByName['targetfaces'].hasNewData() and targetfaces: 
...
class ConnectedComponents(GeometryNode):
    ...
    Output:
          - ConnectedComponents: first geometry in the list 
          - allGeometries:       list of all split geometries   
    """
    ...
    def __init__(self, name='ConnectedComponents', **kw):
        ...
        ip.append(name = 'onegeom', datatype='int', required=False)
        ...
        code = """def doit(self, geometry, onegeom=0, name = None, geoms=None,
                           instanceMatrices=None, geomOptions=None, parent=None):
