...
#########################################################################
#
# $Header: /opt/cvs/VisionLibraries/scipylib/signal/timeRange.py,v 1.1 2007/11/28 23:09:08 mgltools Exp $
#
# $Id: timeRange.py,v 1.1 2007/11/28 23:09:08 mgltools Exp $
#
...
class timeRange(NetworkNode):
    ...
    def __init__(self, constrkw = {},  name='timeRange', **kw):
        ...
        code = """def doit(self, t0, t1,fs=100):
    import scipy
