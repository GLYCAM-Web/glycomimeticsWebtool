...
from matplotlib.cbook import iterable, popd
try:
...
#            ax.zoomy(kw['zoomy'])
        ...
        if kw.has_key('legendlabel'):
            ...
            if kw.has_key('legend.labelsep'):
                labelsep=kw['legend.labelsep']
            else:    
                labelsep=rcParams['legend.labelsep']
            if kw.has_key('legend.handlelen'):
                handlelen=kw['legend.handlelen']
            else:    
                handlelen=rcParams['legend.handlelen']
            if kw.has_key('legend.handletextsep'):
                handletextsep=kw['legend.handletextsep']
            else:    
                handletextsep=rcParams['legend.handletextsep'] 
            if kw.has_key('legend.axespad'):
                axespad=kw['legend.axespad']
            else:    
                axespad=rcParams['legend.axespad']
...
"""
        ...
        ip.append(datatype='float', required=False, name='linewidth')
        ...
        ip.append(datatype='boolean', required=False, name='frameon')
        ip.append(datatype='boolean', required=False, name='hold')
	...
	op = self.outputPortsDescr
        ...
        code = """def doit(self, plots=None, width=None, height=None, linewidth=1,
dpi=None, facecolor=None, edgecolor=None, master=None, nbRows=None,
nbColumns=None, frameon=True, hold=False, toolbar=True, packOpts=None):
    ...
    figure.set_figsize_inches(width,height)
...
"""
        ...
        ip.append(datatype='float', required=False, name='alphaFace')
        ip.append(datatype='float', required=False, name='alphaEdge')
        ip.append(datatype='boolean', required=False, name='frameon')
        ip.append(datatype='boolean', required=False, name='hold')
        ...
        code = """def doit(self, plots=None, width=None, height=None, dpi=None, facecolor=None, edgecolor=None, alphaFace=0.5, alphaEdge=0.5, frameon=True, hold=False):
    figure = self.figure
    try:
    ...
    #figure.set_figsize_inches(width,height)
    figure.set_figsize_inches(w / dpi, h / dpi)
    
    for p in plots:
        if hasattr(p,"figure"):
            p.figure.set_figwidth(w / dpi)
            p.figure.set_figheight(h / dpi)
            figure.add_axes(p)
            p.set_figure(figure)
...
class MPLDrawAreaNE(NetworkNode):
    ...
    def __init__(self, name='Draw Area', **kw):
        ...
        ip = self.inputPortsDescr
        ip.append(datatype='float', required=False, name='left')
        ip.append(datatype='float', required=False, name='bottom')
        ip.append(datatype='float', required=False, name='width')
        ip.append(datatype='float', required=False, name='height')
        ip.append(datatype='boolean', required=False, name='frameon')
        ip.append(datatype='boolean', required=False, name='hold')
        ip.append(datatype='string', required=False, name='title')
        ip.append(datatype='string', required=False, name='xlabel')
        ip.append(datatype='string', required=False, name='ylabel')
        ip.append(datatype='string', required=False, name='xlimit')
        ip.append(datatype='string', required=False, name='ylimit')
        ip.append(datatype='boolean', required=False, name='xticklabels')
        ip.append(datatype='boolean', required=False, name='yticklabels')
        ip.append(datatype='boolean', required=False, name='axison')
        ip.append(datatype='boolean', required=False, name='autoscaleon')
	...
	op = self.outputPortsDescr
        ...
        code = """def doit(self, left=.1, bottom=.1,
width=.8, height=.8, frameon=True, hold=False, title='Figure', xlabel='X',
ylabel='Y', xlimit='',ylimit='',xticklabels=True,yticklabels=True,axison=True,autoscaleon=True):
...
"""
    ...
    def __init__(self, name='Fill', **kw):
        ...
        ip.append(datatype='string', required=False, name='fillcolor')
        ...
        code = """def doit(self,x,y,fillcolor='w',drawAreaDef=None):
    self.axes.clear()
    ax=self.axes
...
"""
    def __init__(self, name='PolarAxes', **kw):
        ...
        ip.append(datatype='list', name='y',beforeDisconnect=self.codeBeforeDisconnect)
        ip.append(datatype='list',  name='x',beforeDisconnect=self.codeBeforeDisconnect) 
        ip.append(datatype='string', required=False, name='lineStyle')
        ip.append(datatype='None', required=False, name='color')
        ip.append(datatype='boolean', required=False, name='grid')
        ip.append(datatype='str', required=False, name='gridlineStyle')
        ip.append(datatype='str', required=False, name='gridcolor')
        ip.append(datatype='float', required=False, name='gridlinewidth')
        ip.append(datatype='str', required=False, name='axisbg')
        ip.append(datatype='str', required=False, name='xtickcolor')
        ip.append(datatype='str', required=False, name='ytickcolor')
        ip.append(datatype='float', required=False, name='xticksize')
        ip.append(datatype='float', required=False, name='yticksize')
        ip.append(datatype='MPLDrawArea', required=False,name='drawAreaDef',singleConnection=False)
        ...
        op = self.outputPortsDescr
        op.append(datatype='MPLFigure', name='figure')
        code = """def doit(self, y,x,lineStyle='solid',color='black',grid=1,gridlineStyle="--",gridcolor="gray",gridlinewidth=1,axisbg="white",xtickcolor="black",ytickcolor="black",xticksize=12,yticksize=12,drawAreaDef=None):
...
"""    
    def __init__(self, name='Stem', **kw):
        ...
        ip.append(datatype='string',required=False,name='stemlinestyle')
        ip.append(datatype='string',required=False,name='stemlinecolor')
        ip.append(datatype='string',required=False,name='markerstyle')
        ip.append(datatype='string',required=False,name='markerfacecolor')
        ip.append(datatype='string',required=False,name='baselinecolor')
        ip.append(datatype='string',required=False,name='baselinestyle')
        ip.append(datatype='MPLDrawArea', required=False,name='drawAreaDef',singleConnection=False)
        ...
        code = """def doit(self,x,y,stemlinestyle='--',stemlinecolor="b",markerstyle='o',markerfacecolor='b',baselinecolor='b',baselinestyle="-",drawAreaDef=None):
    self.axes.clear()
...
input: axes instances
    ...
    def __init__(self, name='MultiPlot', **kw):
        ...
        code = """def doit(self, plots=None,drawAreaDef=None):
    self.axes.clear()
    ax=self.axes
    if len(plots)>0:
...
""" 
    def __init__(self, name='TablePlot', **kw):
        ...
        ip.append(datatype='string',required=False, name='location')
        ip.append(datatype='MPLDrawArea',required=False,name='drawAreaDef',singleConnection=False)
        ...
        code = """def doit(self,values,rowLabels,colLabels,rowColors=None,colColors=None,location='bottom',drawAreaDef=None):
    self.axes.clear()
    self.setDrawAreaDef(drawAreaDef)
...
"""    
    def __init__(self, name='Histogram', **kw):
        ...
        ip.append(datatype='None', required=False, name='bins')
        ip.append(datatype='boolean', required=False, name='normed')
        ip.append(datatype='float', required=False, name='patch_antialiased')
        ip.append(datatype='float', required=False, name='patch_linewidth')
        ip.append(datatype='string', required=False, name='patch_edgecolor')
        ip.append(datatype='string', required=False, name='patch_facecolor')
        ip.append(datatype='MPLDrawArea',required=False,name='drawAreaDef',singleConnection=False)
	...
	op = self.outputPortsDescr
        ...
        code = """def doit(self, values, bins=10, normed=False,patch_antialiased=1,patch_linewidth=1,patch_edgecolor='black',patch_facecolor='blue',drawAreaDef=None):
    self.axes.clear()
...
"""
	...
	self.joinstyles = Line2D.validJoin
        ...
        ip.append(datatype='string', required=False, name='lineStyle')
        ip.append(datatype='None', required=False, name='color')
        ip.append(datatype='boolean', required=False, name='line_antialiased')
        ip.append(datatype='float', required=False, name='line_linewidth')
        ip.append(datatype='string', required=False, name='solid_joinstyle')
        ip.append(datatype='string', required=False, name='solid_capstyle')
        ip.append(datatype='string', required=False, name='dash_capstyle')
        ip.append(datatype='string', required=False, name='dash_joinstyle')
        ip.append(datatype='MPLDrawArea', required=False,name='drawAreaDef',singleConnection=False)
	...
	self.widgetDescr['color'] = {
        ...
        code = """def doit(self, y, x=None, lineStyle='solid',color='black',line_antialiased=1,line_linewidth=1,solid_joinstyle='miter',solid_capstyle='projecting',dash_capstyle='butt',dash_joinstyle='miter',drawAreaDef=None):
    self.axes.clear() 
    self.setDrawAreaDef(drawAreaDef)
    colorChar = self.colors[color]
    lineStyleChar = self.styles[lineStyle]
...
"""   
	...
	self.joinstyles = Line2D.validJoin
        ...
        ip.append(datatype='string', required=False, name='lineStyle')
        ip.append(datatype='None', required=False, name='color')
        ip.append(datatype='string', required=False, name='tz')
        ip.append(datatype='boolean', required=False, name='xdate')
        ip.append(datatype='boolean', required=False, name='ydate')
        ip.append(datatype='boolean', required=False, name='line_antialiased')
        ip.append(datatype='float', required=False, name='line_linewidth')
        ip.append(datatype='string', required=False, name='solid_joinstyle')
        ip.append(datatype='string', required=False, name='solid_capstyle')
	...
	self.widgetDescr['color'] = {
        ...
        code = """def doit(self, y, x=None, lineStyle='solid',color='black',tz='US/PACIFIC',xdate=True,ydate=False,line_antialiased=1,line_linewidth=1,solid_joinstyle='miter',solid_capstyle='projecting',dash_capstyle='butt',dash_joinstyle='miter',drawAreaDef=None):
    try:
       from pytz import common_timezones
    except:
...
"""
	...
	op = self.outputPortsDescr
        ...
        code = """def doit(self, fractions, labels=None, shadow=None,
explode=None, format=None, drawAreaDef=None):
    self.axes.clear()
    self.setDrawAreaDef(drawAreaDef)
...
"""
    ...
    def __init__(self, name='Spy', **kw):
        ...
        ip.append(datatype='string', required=False, name='marker')
        ...
        op = self.outputPortsDescr
        op.append(datatype='MPLAxes', name='plot')
        code = """def doit(self, Z, marker='s',markersize=10,drawAreaDef=None):
    self.axes.clear()
    self.setDrawAreaDef(drawAreaDef)
...
"""
    def __init__(self, name='Spy2', **kw):
        ...
        code = """def doit(self, Z, drawAreaDef=None):
    self.axes.clear()
    self.setDrawAreaDef(drawAreaDef)
    im=self.axes.spy2(Z)
    self.canvas.draw()
...
"""    
    def __init__(self, name='Vline', **kw):
        ...
        ip.append(datatype='string', required=False, name='color')
        ip.append(datatype='string', required=False, name='linestyle')
        ip.append(datatype='MPLDrawArea', required=False, name='drawAreaDef',singleConnection=False)
        self.widgetDescr['color'] = {
            'class':'NEComboBox', 'master':'node',
        ...
        code = """def doit(self, x,ymin,ymax,color='k',linestyle='-', drawAreaDef=None):
    self.axes.clear()
    self.setDrawAreaDef(drawAreaDef)
...
"""
	...
	op = self.outputPortsDescr
        ...
        code = """def doit(self, x, y, s=None, c='k', marker='circle',solid_joinstyle='miter',solid_capstyle='projecting',dash_capstyle='butt',dash_joinstyle='miter', drawAreaDef=None):
...
"""
    ...
    def __init__(self, name='ScatterClassic', **kw):
        ...
        op.append(datatype='MPLAxes', name='plot')
        op.append(datatype='None', name='patches')
        code = """def doit(self, x, y, s=None, c=None,solid_joinstyle='miter',solid_capstyle='projecting',dash_capstyle='butt',dash_joinstyle='miter', drawAreaDef=None):
    kw={'solid_joinstyle':solid_joinstyle,'solid_capstyle':solid_capstyle,'dash_capstyle':dash_capstyle,'dash_joinstyle':dash_joinstyle}
    self.axes.clear()
    self.setDrawAreaDef(drawAreaDef)
...
"""
    ...
    def __init__(self, name='Figimage', **kw):
        ...
        ip.append(datatype='string',required=False, name='imaspect')
        ip.append(datatype='string',required=False, name='interpolation')
        ip.append(datatype='string',required=False, name='origin')
        ip.append(datatype='None', required=False, name='alpha')
        ip.append(datatype='MPLDrawArea', required=False, name='drawAreaDef',singleConnection=False)
	...
	op = self.outputPortsDescr
        ...
        code = """def doit(self, data,cmap='jet',imaspect='equal',interpolation='bilinear',origin='upper',alpha=1.0,drawAreaDef=None):
...
"""
    def __init__(self, name='PcolorMesh', **kw):
        ...
        ip.append(datatype='string',required=False,  name='cmap')
        ip.append(datatype='string',required=False,  name='shading')
        ...
        code = """def doit(self, x=None,y=None,z=None,cmap='jet',shading='faceted',alpha=1.0,drawAreaDef=None):
    self.axes.clear()
    self.setDrawAreaDef(drawAreaDef)
...
"""
    def __init__(self, name='PcolorClassic', **kw):
        ...
        code = """def doit(self, x=None,y=None,z=None,cmap='jet',shading='faceted',alpha=0.75,drawAreaDef=None):
    self.axes.clear()
    self.setDrawAreaDef(drawAreaDef)
    #pseudo color plot of Z
    Qz=z
...
"""
    ...
    def __init__(self, name='Contour', **kw):
        ...
        ip.append(datatype='None', required=False,name='arraylisty')
        ip.append(datatype='None', name='arraylistz',beforeDisconnect=self.codeBeforeDisconnect)
        ip.append(datatype='string', required=False,  name='contour')
        ip.append(datatype='int', required=False, name='length_colors')
        ip.append(datatype='string', required=False, name='cmap')
        ip.append(datatype='string', required=False, name='colors')
        ip.append(datatype='string', required=False, name='origin')
        ip.append(datatype='int', required=False, name='linewidth')
        ip.append(datatype='boolean', required=False, name='hold')
        ip.append(datatype='MPLDrawArea', required=False, name='drawAreaDef',singleConnection=False)
        ...
        code = """def doit(self,x=None,y=None,z=None,contour="default",col_len=None,cmapval='jet',colors='black',origin='upper',linewidth=1,hold=0,drawAreaDef=None):
    self.axes.clear()
    self.setDrawAreaDef(drawAreaDef)            
    ...
    #Z=10.0*(numerix.array(z2) - numerix.array(z1))
    Z=z
    if col_len:
        cmap = cm.get_cmap(cmapval,int(col_len))
    else:
    ...
    if x==None or y==None:
        ...
        if contour=='default':    
            ...
            CS=self.axes.contourf(numerix.array(Z),cmap=cmap,origin=origin)
    else:
        ...
        if contour=='default':
            ...
            CS=self.axes.contourf(X,Y,numerix.array(Z),cmap=cmap,origin=origin)
    self.canvas.draw()
...
""" 
    def __init__(self, name='Specgram', **kw):
        ...
        ip.append(datatype='int', name='NFFT')
        ip.append(datatype='int', name='Fs')
        ip.append(datatype='string', required=False, name='cmap')
        ip.append(datatype='int', name='nOverlap')
        ip.append(datatype='MPLDrawArea', required=False, name='drawAreaDef',singleConnection=False)
        ...
        op.append(datatype='MPLAxes', name='axes')
        op.append(datatype=None,name='image')
        code="""def doit(self,x,NFFT=256,Fs=2,cmapval=None,nOverlap=128,drawAreaDef=None):
    self.axes.clear()
    self.setDrawAreaDef(drawAreaDef)
    cmap=eval("cm.%s" %cmapval)
...
"""
    def __init__(self, name='CSD', **kw):
        ...
        op = self.outputPortsDescr
        op.append(datatype='MPLAxes', name='axes')
        code="""def doit(self,arraylistx,arraylisty,NFFT=256,Fs=2,nOverlap=128,drawAreaDef=None):
    self.axes.clear()
    self.setDrawAreaDef(drawAreaDef)
...
"""
    def __init__(self, name='PSD', **kw):
        ...
        ip = self.inputPortsDescr
        ip.append(datatype=None, name='arraylistx',singleConnection='auto',beforeDisconnect=self.codeBeforeDisconnect)
        ip.append(datatype='int', required=False,name='NFFT')
        ip.append(datatype='int', required=False,name='Fs')
        ip.append(datatype='int', required=False,name='nOverlap')
        ip.append(datatype='MPLDrawArea', required=False, name='drawAreaDef',singleConnection=False)
        self.widgetDescr['NFFT'] = {
            'class':'NEEntry', 'master':'ParamPanel',
            'labelCfg':{'text':'NFFT (powOf 2):'},'width':10,
        ...
        op = self.outputPortsDescr
        op.append(datatype='MPLAxes', name='axes')
        code="""def doit(self,x,NFFT=256,Fs=2,nOverlap=0,drawAreaDef=None):
    self.axes.clear()
    self.setDrawAreaDef(drawAreaDef)
...
"""
    ...
    def __init__(self, name='LogCurve', **kw):
        ...
        ip.append(datatype='list', name='x',beforeDisconnect=self.codeBeforeDisconnect)
        ip.append(datatype='list', name='y',beforeDisconnect=self.codeBeforeDisconnect)
        ip.append(datatype='string',required=False, name='logCurve')
        ip.append(datatype='float',required=False, name='basex')
        ip.append(datatype='float',required=False, name='basey')
        ip.append(datatype='MPLDrawArea', required=False, name='drawAreaDef',singleConnection=False)
        ...
        op = self.outputPortsDescr
        op.append(datatype='MPLAxes', name='axes')
        code="""def doit(self,x,y,logCurve=log,basex=10,basey=10,drawAreaDef=None):
    self.axes.clear()
    self.setDrawAreaDef(drawAreaDef)
...
input:
    ...
    def __init__(self, name='Semilogx', **kw):
        ...
        op = self.outputPortsDescr
        op.append(datatype='MPLAxes', name='axes')
        code="""def doit(self,x,y,basex=10,drawAreaDef=None):
    self.axes.clear()
    self.setDrawAreaDef(drawAreaDef)
...
input:
    ...
    def __init__(self, name='Semilogy', **kw):
        ...
        op = self.outputPortsDescr
        op.append(datatype='MPLAxes', name='axes')
        code="""def doit(self,x,y,basey=10,drawAreaDef=None):
    self.axes.clear()
    self.setDrawAreaDef(drawAreaDef)
...
"""
    def __init__(self, name='BoxPlot', **kw):
        ...
        ip.append(datatype=None, required=False, name='widths')
        ip.append(datatype='boolean', required=False, name='notch')
        ip.append(datatype='boolean', required=False, name='vert')
        ip.append(datatype='string', required=False, name='color')
        ip.append(datatype='string', required=False, name='linestyle')
        ip.append(datatype='float', required=False, name='whis')
        ip.append(datatype='MPLDrawArea', required=False, name='drawAreaDef',singleConnection=False)
        ...
        op.append(datatype='MPLAxes', name='axes')
        op.append(datatype=None, name='lines')
        code="""def doit(self,x,positions=None,widths=0.15,notch=0,vert=0,color='b',linestyle='-',whis=1.5,drawAreaDef=None):
    self.axes.clear()
    self.setDrawAreaDef(drawAreaDef)
    sym=color+linestyle
...
"""
    def __init__(self, name='Bar', **kw):
        ...
        ip.append(datatype='None', required=False,name='bottom')    
        ip.append(datatype='None', required=False,name='width')
        ip.append(datatype='None', required=False, name='xerr')    
        ip.append(datatype='None', required=False, name='yerr')
        ip.append(datatype='string', required=False, name='color')
        ip.append(datatype='string', required=False, name='edgecolor')
        ip.append(datatype='string', required=False, name='ecolor')
        ip.append(datatype='int', required=False, name='capsize')
        ip.append(datatype='list', required=False, name='align')
        ip.append(datatype='list', required=False, name='orientation')
        ip.append(datatype='MPLDrawArea', required=False, name='drawAreaDef',singleConnection=False)
        ...
        op.append(datatype='MPLAxes', name='axes')
        op.append(datatype=None, name='patches')
        code="""def doit(self,left,height,bottom=0,width=0.8,xerr=None,yerr=None,color='b',edgecolor='b',ecolor='b',capsize=3,align='edge',orientation='vertical',drawAreaDef=None):        
    self.axes.clear()
    self.setDrawAreaDef(drawAreaDef)
...
"""
    def __init__(self, name='BarH', **kw):
        ...
        ip.append(datatype='None', required=False, name='height')
        ip.append(datatype='None', required=False, name='left')
        ip.append(datatype='None', required=False, name='xerr')    
        ip.append(datatype='None', required=False, name='yerr')
        ip.append(datatype='string', required=False, name='color')
        ip.append(datatype='string', required=False, name='edgecolor')
        ...
        op.append(datatype='MPLAxes', name='axes')
        op.append(datatype=None, name='patches')
        code="""def doit(self,bottom,width,height=0.8,left=0,xerr=None,yerr=None,color='b',edgecolor='b',ecolor='b',capsize=3,align='edge',drawAreaDef=None):        
    self.axes.clear()
    self.setDrawAreaDef(drawAreaDef)
...
"""
    def __init__(self, name='Quiver', **kw):
        ...
        ip.append(datatype='None', required=False, name='color')
        ip.append(datatype='float', required=False, name='S')
        ip.append(datatype='float', required=False, name='width')
        ip.append(datatype='string', required=False, name='pivot')
        ip.append(datatype='string', required=False, name='units')
        ip.append(datatype='MPLDrawArea', required=False, name='drawAreaDef',singleConnection=False)
        self.widgetDescr['color'] = {
            'class':'NEComboBox', 'master':'ParamPanel',
            'choices':colors.values(), 
        ...
        op = self.outputPortsDescr
        op.append(datatype='MPLAxes', name='axes')    
        code="""def doit(self,u,v,x=None,y=None,color=None,S=0.20,width=1.0,pivot='tip',units='inches',drawAreaDef=None):
    self.axes.clear()
    self.setDrawAreaDef(drawAreaDef)
    if x!=None:
...
"""
    def __init__(self, name='ErrorBar', **kw):
        ...
        ip.append(datatype='string', required=False, name='ecolor')
        ip.append(datatype='int', required=False, name='capsize')
        ip.append(datatype='boolean', required=False, name='barsabove')
        ip.append(datatype='boolean', required=False, name='controlmarkers')
        ip.append(datatype='MPLDrawArea', required=False, name='drawAreaDef',singleConnection=False)
        self.widgetDescr['format'] = {
            'class':'NEComboBox', 'master':'ParamPanel',
            'choices':get_styles().values(),
        ...
        op = self.outputPortsDescr
        op.append(datatype='MPLAxes', name='axes')
        code="""def doit(self,x,y,xerr=None,yerr=None,format='b-',ecolor='b',capsize=3,barsabove=0,controlmarkers=0,drawAreaDef=None):
    self.axes.clear()
    self.setDrawAreaDef(drawAreaDef)
    fmt=ecolor+format
    if controlmarkers == 0:
...
"""
    ...
    from matplotlib import numerix
    x = numerix.arange(x0, x1, step)
    y = numerix.sin(2*numerix.pi*x)
...
class NEMatPlotLibOptions(PortWidget):
    ...
    def __init__(self, port, **kw):
        ...
        self.booleanProps =['axisbelow','gridOn','figpatch_antialiased','text.usetex','text.dvipnghack','hold','legend.isaxes','legend.shadow','mathtext.mathtext2']#visible
        self.twProps=['linewidth','xtick.labelsize','xtick.labelrotation','ytick.labelsize','ytick.labelrotation','gridlinewidth','figpatch_linewidth','markeredgewidth',
                                #'zoomx','zoomy',
                                'legend.numpoints','legend.pad','legend.markerscale','legend.handlelen','legend.axespad','legend.labelsep','legend.handletextsep','xtick.major.size','ytick.major.size','xtick.minor.size','ytick.minor.size','xtick.major.pad','ytick.major.pad','xtick.minor.pad','ytick.minor.pad','font.size']
...
"""
        ...
        op = self.outputPortsDescr
        op.append(datatype='MPLDrawArea', name='drawAreaDef')
        code = """def doit(self,label,location='upper right', drawAreaDef=None):
...
"""
    ...
    def __init__(self, name='ColorBar', **kw):
        ...
        ip.append(datatype='string', required=False, name='extend')
        ip.append(datatype='float', required=False, name='orientation')
        ip.append(datatype='string', required=False, name='spacing')
        ip.append(datatype='float', required=False, name='shrink')
        ...
        op = self.outputPortsDescr
        op.append(datatype='MPLAxes', name='axes')
        code = """def doit(self,plot,current_image=None,extend='neither',orientation="vertical",spacing='uniform',shrink=1.0):
...
"""
    def __init__(self, name='Text', **kw):
        ...
        ip = self.inputPortsDescr
        ip.append(datatype='float', required=False, name='posx')
        ip.append(datatype='float', required=False, name='posy')
        ip.append(datatype='string', required=False, name='textlabel')
        ip.append(datatype='string', required=False, name='rotation')
        ip.append(datatype='string', required=False, name='horizontalalignment')
        ip.append(datatype='string', required=False, name='verticalalignment')
        ...
        code = """def doit(self, posx=.1, posy=.1,textlabel='',rotation=0,horizontalalignment='center',verticalalignment='center'):
...
"""
    def __init__(self, name='saveFig', **kw):
        ...
        ip.append(datatype=None, required=False, name='dpi')
        ip.append(datatype=None, required=False, name='facecolor')
        ip.append(datatype=None, required=False, name='edgecolor')
        ip.append(datatype=None, required=False, name='orientation')
        ...
        code = """def doit(self,figure,fname,dpi=80,facecolor='w', edgecolor='w', orientation='portrait', papertype=None, format=None):
    if figure:
...
class BivariateNormal(NetworkNode):
    ...
    def __init__(self, name='BivariateNormal', **kw):
        ...
        ip.append(datatype='float', required=False, name='sigmax')
        ip.append(datatype='float', required=False, name='sigmay')
        ip.append(datatype='float', required=False, name='mux')
        ip.append(datatype='float', required=False, name='muy')
        ip.append(datatype='float', required=False, name='sigmaxy')
        ...
        code = """def doit(self,x,y,sigmax=1.0,sigmay=1.0,mux=0.0,muy=0.0,sigmaxy=0.0):
    X=numerix.array(x)
    Y=numerix.array(y)
