...
You have to provide one as the second argument' % key);
    ...
    def parse_PDB_ATOM_record(self, rec, mol):
        ...
        #print "Processed rec is %s"%(rec)
        #print "PDB record %s %s %s"%(rec[12:16], rec[76:78], rec[78:80])
        #Yao:Right now element is assinged to the first 2 characters of the atom. Hack it to read the element column. 
        element = strip(rec[76:78]) #Yao's hack
