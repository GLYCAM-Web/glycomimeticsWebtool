...
# $Header: /opt/cvs/python/packages/share1.5/Pmv/moleculeViewer.py,v 1.160.2.7 2009/05/14 18:33:53 sargis Exp $

#
# $Id: moleculeViewer.py,v 1.160.2.7 2009/05/14 18:33:53 sargis Exp $
#
...
""")
        choices = [1,0]
        self.userpref.add('Selection Spheres', 1, validValues=choices,
                          category="Molecules",
...
application"""
        ...
        self.userpref.add( 'Save Perspective on Exit', 'yes', 
                           validValues = ['yes', 'no'],
                           callbackFunc = [self.perspectivePref_cb],
