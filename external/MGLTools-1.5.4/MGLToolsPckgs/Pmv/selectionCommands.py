...
# $Header: /opt/cvs/python/packages/share1.5/Pmv/selectionCommands.py,v 1.135.2.3 2008/11/24 21:05:17 rhuey Exp $
#
# $Id: selectionCommands.py,v 1.135.2.3 2008/11/24 21:05:17 rhuey Exp $
#
...
##                                        self.vf.ICmdCaller.level.value.__name__)
    ...
    def updateSelectionIcons(self):
        ...
        if self.vf.userpref['Selection Spheres']['value']==1:
...
#                    })
    ...
    def guiCallback(self):
        if not hasattr(self, 'ifd'):
            ...
            self.form.deiconify()
            self.form.lift()
        self.showSelSpheres.set(self.vf.userpref['Selection Spheres']['value'])
    ...
    def toggleSelSpheres(self, event = None):
        if self.vf.userpref['Selection Spheres']['value']==1:
            self.vf.userpref.set('Selection Spheres',0)
        else:
            self.vf.userpref.set('Selection Spheres',1)
        self.showSelSpheres.set(self.vf.userpref['Selection Spheres']['value'])
