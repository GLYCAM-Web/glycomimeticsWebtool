...
#
# $Header: /opt/cvs/python/packages/share1.5/Pmv/displayCommands.py,v 1.186.2.2 2008/11/19 21:20:35 vareille Exp $
# 
# $Id: displayCommands.py,v 1.186.2.2 2008/11/19 21:20:35 vareille Exp $
#
...
class DisplayCPK(DisplayCommand):
    ...
    def __call__(self, nodes, only=False, negate=False, 
                 scaleFactor=1.0,  cpkRad=0.0, quality=0,  byproperty = False, propertyName = None,
                 propertyLevel = 'Molecule', **keywords):
