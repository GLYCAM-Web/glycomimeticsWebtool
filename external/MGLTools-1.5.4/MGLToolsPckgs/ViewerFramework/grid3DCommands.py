...
#########################################################################
# 
# $Header: /opt/cvs/python/packages/share1.5/ViewerFramework/grid3DCommands.py,v 1.11.2.4 2009/06/19 17:08:36 sargis Exp $
# $Id: grid3DCommands.py,v 1.11.2.4 2009/06/19 17:08:36 sargis Exp $
   ...
   \nSynopsis:\n
    ...
    def doit(self, gridFile, name=None, show=True, normalize=True):
        ...
        if grid3D:
            ...
            self.vf.addGrid(grid3D, grid_basename)
